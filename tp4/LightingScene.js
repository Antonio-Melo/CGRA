...
LightingScene.prototype.init = function(application) {
	...
	this.materialC.setAmbient(1, 1, 0, 1);
	this.materialC.setDiffuse(0.8, 0.1, 0.1, 1);
 	this.materialC.setSpecular(0.8, 0.1, 0.1, 1);


 	this.materialD = new CGFappearance(this);
	this.materialD.setAmbient(0, 0, 0, 0.1);
	this.materialD.setDiffuse(1, 0.9, 0.5, 0.1);
 	this.materialD.setSpecular(1, 0.9, 1, 0.1); 
	...
	this.trashAppearance = new CGFappearance(this);
	this.trashAppearance.loadTexture("\\resources\\images\\trash.jpg");
...
//	this.lights[1].setVisible(true); // show marker on light position (different from enabled)
	...
	this.lights[2].setPosition(16.5, 6.0, 5.0, 1.0);
...
//	this.lights[2].enable();
	...
	this.lights[3].setPosition(8.0, 8.0, 12.0, 1.0);
//	this.lights[3].setVisible(true);
	this.lights[3].setDiffuse(1.0, 1.0, 1.0, 1.0);
	this.lights[3].setSpecular(1.0, 1.0, 0.5, 1.0);
